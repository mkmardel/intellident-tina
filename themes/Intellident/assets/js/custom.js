...
(function ($) {
    ...
    window.onload = function () {
        // document.getElementById('owl-carousel')?.addEventListener("mousemove", function () {
        //     document.getElementById('swipe-gif').style.visibility = 'hidden';
        // });
        // document.getElementById('owl-carousel')?.addEventListener("touchmove", function () {
        //     document.getElementById('swipe-gif').style.visibility = 'hidden';
        // });
    ...
    THEMEMASCOT.initialize = {
        ...
        TM_preLoaderClickDisable: function () {
            ...
            // Show disable button only when click event subscribed
            $preloader.children('#disable-preloader').removeClass('hidden');
            // Preloader timeout
            let pto = setTimeout(() => {
                $preloader.fadeOut();
                clearTimeout(pto);
    ...
    THEMEMASCOT.header = {
        ...
        TM_scroolToTop: function () {
            if ($window.scrollTop() > 600) {
                $('.scrollToTop').fadeIn();
                $('.cookie-banner').addClass('banner-up');
            } else {
                $('.scrollToTop').fadeOut();
                $('.cookie-banner').removeClass('banner-up');
...
function initCookieBar() {
    setTimeout(() => {
        if (!localStorage.cookie_banner_closed) {
            $('.cookie-banner').css('display', 'inherit');
        } else {
            $('.cookie-banner').css('display', 'none');
        }
        $('.cookie-banner button').click(function () {
            $('.cookie-banner').css('display', 'none');
            localStorage.cookie_banner_closed = 'true';
        });
